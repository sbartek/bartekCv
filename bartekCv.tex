...
\noindent\logomar{imgs/lilleBN.png}{0.5cm}\textit{Universit{\'e} Lille 1} $\bullet$ Lille $\bullet$ France \hfill 2010\\
\noindent{\small\textbf{Visiting Professor} $\bullet$ research on Dynamical Systems}\\
\noindent\logomar{imgs/UNTBN.png}{0.3cm}\textit{University of North Texas} $\bullet$ Denton $\bullet$ USA \hfill 2009, 2007\\
...
\noindent\logomar{imgs/PWBN.png}{0.5cm}\textit{Warsaw University of Technology} $\bullet$  Warsaw $\bullet$ Poland \hfill 2000--2004\\ 
\noindent{\small\textbf{PhD student} $\bullet$ taught undergraduate courses}\\
\noindent\logomar{imgs/UoWBN.png}{0.3cm}\textit{University of Warwick} $\bullet$ Coventry $\bullet$ UK \hfill 2003\\
