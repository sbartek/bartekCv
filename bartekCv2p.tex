...
\usepackage[top=1cm, bottom=1cm, left=1.8cm, right=1.5cm]{geometry}
\input{cvHead}
...
Learning to solve business problems. Working mostly within multidisciplinary teams that consisted
of, for example, Product Managers, Developers, Designers, Researchers, QA, etc.
\item More then 4 years experience of teaching and explaining Data Science, Data Management, Machine
  Learning and Statistics concepts for both, technical and non-technical audiences.
\item More then 3 years of Tech Lead experience mentoring other team members.
\item 2 years experience as Team Lead.
\item Experience as member of executive team helping setting up and develop data strategy.
\item Proficiency with tools like Python, Spark, R, SQL, pytorch, sklearn, Hive, Tableau.
\item Familiarity with Docker, Kubernetes, Ruby. 
\item \textbf{PhD} in Mathematics.
