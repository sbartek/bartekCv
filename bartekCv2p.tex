...
\usepackage[top=1.3cm, bottom=1cm, left=1.8cm, right=1.5cm]{geometry}
\input{cvHead}
...
\noindent Data Scientist $\bullet$ Machine/Deep Learning Expert $\bullet$ Experimentation Expert

\noindent Teaching Data Science Courses $\bullet$ Tech and Team Lead

\noindent PhD in Mathematics
