...
\item \textbf{Artificial Inteligence \& Data Science} Experience in applying Machine Learning and Statistics to solve business problems.
...
\item \textbf{Software Engineering} Experience in building highly performance applications in Rust and C++. Also eßßxperience in buliding web apps (Ruby on Rails, Django).
\item \textbf{Management} Tech and Team Lead experience managing and mentoring other team members.
\item \textbf{Research in Aritficial Inteligence and Data Science} Experience in leading Machine Learning and Data Science research. Co-author of ML and DS publications and a patent.
...
\item Proficiency with programming languages like Python, Scala, R, SQL, Rust, C++, Haskel.
\item Proficiency with tools like Spark, PyTorch, TensorFlow, scikit-learn, Hive, Tableau.
\item Experience with AWS, Docker, Kubernetes, JavaScript and Ruby. 
...
\noindent\makebox[\linewidth]{\rule{\textwidth}{0.4pt}}
\marginpar{
  \sectit{Machine Learning, Software Engineering and Data Science Experience}
}
\vspace{-0.1cm}

\noindent\logomar{imgs/meta_logo.png}{1.4cm}
...
{\small I've been applying Machine Learning to detect frauds in WhatsApp (\texttt{Python}, \texttt{Haskel}, \texttt{Hack}).
I've also worked on WhatsApp's protocol tooling mostly using \texttt{Rust} and \texttt{C++}.}\\
...
\noindent\textbf{Ph.D. in Dynamical Systems (Maths)} Warsaw University of Technology $\bullet$ Warsaw $\bullet$ Poland\\
\noindent\textbf{M.Sc. in Mathematics Education} University of Bialystok $\bullet$ Białystok $\bullet$ Poland\\
...
\noindent\textbf{Coursera/edX/Udacity/Udemy}\\
...
\noindent\llap{\FA \faPencil\ \ }Author of \textbf{articles} in area of Aritficial Inteligence, Data Science and Mathematics.\\
